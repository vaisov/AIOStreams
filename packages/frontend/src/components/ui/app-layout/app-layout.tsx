...
export const AppLayoutAnatomy = defineStyleAnatomy({
  root: cva(['UI-AppLayout__root appLayout', 'flex w-full group/appLayout'], {
    variants: {
      withSidebar: {
    ...
    compoundVariants: [
      {
        withSidebar: true,
        sidebarSize: 'slim',
        className: 'lg:[&>.appLayout]:pl-20',
      },
      {
        withSidebar: true,
        sidebarSize: 'sm',
        className: 'lg:[&>.appLayout]:pl-48',
      },
      {
        withSidebar: true,
        sidebarSize: 'md',
        className: 'lg:[&>.appLayout]:pl-64',
      },
      {
        withSidebar: true,
        sidebarSize: 'lg',
        className: 'lg:[&>.appLayout]:pl-[20rem]',
      },
      {
        withSidebar: true,
        sidebarSize: 'xl',
        className: 'lg:[&>.appLayout]:pl-[25rem]',
      },
    ],
  }),
});
...
export const AppLayoutHeaderAnatomy = defineStyleAnatomy({
  root: cva(['UI-AppLayoutHeader__root', 'relative w-full']),
});
...
export const AppLayoutContentAnatomy = defineStyleAnatomy({
  root: cva(['UI-AppLayoutContent__root', 'relative']),
});

export const AppLayoutFooterAnatomy = defineStyleAnatomy({
  root: cva(['UI-AppLayoutFooter__root', 'relative']),
});

export const AppLayoutStackAnatomy = defineStyleAnatomy({
  root: cva(['UI-AppLayoutStack__root', 'relative'], {
    variants: {
      spacing: {
        sm: 'space-y-2',
        md: 'space-y-4',
...
export const AppLayoutGridAnatomy = defineStyleAnatomy({
  root: cva(['UI-AppLayoutGrid__root', 'relative flex flex-col'], {
    variants: {
      breakBelow: {
