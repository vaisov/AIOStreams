...
export const RadioGroupAnatomy = defineStyleAnatomy({
  ...
  itemCheckIcon: cva(['UI-RadioGroup__itemCheckIcon', 'text-white'], {
    variants: {
      size: {
        sm: 'h-4 w-4',
        md: 'h-4 w-4',
...
export const RadioGroup = React.forwardRef<HTMLButtonElement, RadioGroupProps>(
  (props, ref) => {
    ...
    const [
      ...
      basicFieldProps,
    ] = extractBasicFieldProps<RadioGroupProps>(props, id);
            ...
            {options.map((option) => {
              return (
                <label
                  key={option.value}
                  className={cn(
                    RadioGroupAnatomy.itemContainer(),
                    itemContainerClass
                  )}
                ...
                >
                  ...
                  >
                    <RadioGroupPrimitive.Indicator
                      ...
                      data-error={!!basicFieldProps.error}
                      data-disabled={
                        basicFieldProps.disabled || option.disabled
                      }
                      data-readonly={
                        basicFieldProps.readonly || option.readonly
                      }
                    >
                      {itemCheckIcon ? (
                        itemCheckIcon
                        ...
                        <svg
                          ...
                          fill="currentColor"
                          className={cn(
                            RadioGroupAnatomy.itemCheckIcon({ size }),
                            itemCheckIconClass
                          )}
                        >
                  ...
                  <label
                    ...
                    data-readonly={basicFieldProps.readonly || option.readonly}
                    data-state={
                      _value === option.value ? 'checked' : 'unchecked'
                    }
                  >
