...
const __PaginationAnatomyContext = React.createContext<
  ComponentAnatomy<typeof PaginationAnatomy>
>({});

export type PaginationProps = React.ComponentPropsWithRef<'ul'> &
  ComponentAnatomy<typeof PaginationAnatomy>;

export const Pagination = React.forwardRef<HTMLUListElement, PaginationProps>(
  (props, ref) => {
    const { children, itemClass, className, ellipsisClass, ...rest } = props;
...
export const PaginationTrigger = React.forwardRef<
  HTMLButtonElement,
