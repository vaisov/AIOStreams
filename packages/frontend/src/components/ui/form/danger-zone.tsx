...
export const DangerZoneAnatomy = defineStyleAnatomy({
  ...
  title: cva(['UI-DangerZone__title', 'text-lg text-[--red] font-semibold']),
  dialogTitle: cva([
...
export type DangerZoneProps = React.ComponentPropsWithRef<'div'> &
  ComponentAnatomy<typeof DangerZoneAnatomy> & {
    /**
  ...
  (props, ref) => {
    ...
    return (
      <>
        ...
        <div
          ref={ref}
          className={cn(DangerZoneAnatomy.root(), className)}
          {...rest}
        >
          ...
          <div>
            <h2 className={cn(DangerZoneAnatomy.title(), titleClass)}>
              {locales['dangerZone']['name'][locale]}
            </h2>
            <p className="">
            ...
            >
              {locales['dangerZone']['delete'][locale]}
            </Button>
          </div>
        </div>
        ...
        >
          ...
          <div
            className={cn(DangerZoneAnatomy.dialogAction(), dialogActionClass)}
          >
            <Button
              intent="alert"
              size="sm"
            ...
            >
              {locales['dangerZone']['cancel'][locale]}
            </Button>
          </div>
        </Modal>
      </>
