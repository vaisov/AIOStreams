...
export type CheckboxProps = BasicFieldOptions &
...
export const Checkbox = React.forwardRef<HTMLButtonElement, CheckboxProps>(
  (props, ref) => {
    ...
    ] = extractBasicFieldProps<CheckboxProps>(props, React.useId());
    ...
    const [_value, _setValue] = React.useState<boolean | 'indeterminate'>(
    ...
    return (
      ...
      >
        <label
          className={cn(CheckboxAnatomy.container(), containerClass)}
            ...
            >
              {_value !== 'indeterminate' && (
                <svg
                  ...
                  fill="currentColor"
                  className={cn(
                    CheckboxAnatomy.checkIcon({ size: _size }),
                    checkIconClass
                  )}
                >
